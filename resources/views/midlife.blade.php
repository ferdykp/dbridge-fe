            ...
            <div class="col-12">
                <div class="card mb-4 ">
                    ...
                    <div class="card-header pb-0 d-flex justify-content-between">
                        @if (Auth::user()->role == ['sm', 'supplier'])
                            <div class="d-flex">
                                <a href="{{ route('midilfe.create') }}" class="btn btn-md btn-success me-2">Add Midlife</a>
                        ...
                        <div class="w-25"> <!-- Adjust the width as needed -->
                            <input type="text" id="search"
                                ...
                                placeholder="Search Midlife Code" autocomplete="off" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="card-body px-0 pt-0 pb-4">
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <div>
                                Showing {{ $midlife->firstItem() }} to {{ $midlife->lastItem() }} of
                                {{ $midlife->total() }} entries
                            </div>
                            <div class="d-flex justify-content-center mt-4">
                                {{ $midlife->links('pagination::bootstrap-4') }}
                            </div>
                        </div>
                    </div>
                </div>
