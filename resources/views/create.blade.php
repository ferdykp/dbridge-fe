                    ...
                    <div class="card-body">
                        <form action="{{ route('wr.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" onkeypress="return /[0-9]/i.test(event.key)"
                                            class="form-control @error('wr_item') is-invalid @enderror" name="wr_item"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('qty_req') is-invalid @enderror"
                                            name="qty_req" value="{{ old('qty_req') }}" placeholder="Insert QTY_REQ">
                                        <!-- error message untuk title -->
                                        @error('qty_req')
                                            <div class="alert alert-danger mt-2">
                                                {{ $message }}
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('stock_code') is-invalid @enderror" name="stock_code"
                                    id="stock_code">
