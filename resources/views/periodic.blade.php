                        ...
                        <div class="card-header">
                            <div>
                                <form action="{{ route('periodic.import') }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <button type="submit" class="btn btn-primary mt-2 mt-md-4">Import periodic</button>
                                </form>
                            </div>
                        </div>
                    @endif
                    <div
                        ...
                        <div class="d-flex flex-column w-100 w-md-auto mb-2 mb-md-0">
                            <div class="d-flex flex-column flex-sm-row">
                                @if (in_array(Auth::user()->role, ['user']))
                                    <a href="{{ route('periodic.create') }}"
                                        class="btn btn-md btn-success me-2 mb-2 mb-sm-0">Add
                                        Periodic</a>
                                    <a href="{{ route('periodic.export') }}"
                        ...
                        <div class="form-group me-md-2 w-100 w-md-25">
                            <input type="text" id="search"
                                data-route="{{ route('dynamic.search', ['type' => 'periodic']) }}" name="search"
                                placeholder="Search periodic Code" autocomplete="off" class="form-control">
                        </div>
                    </div>
