                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <h4 class="text-sm mb-4 text-uppercase font-weight-bold">Total Data BCS</h4>
                                    <h5 class="font-weight-bolder">
                                        {{ $bcsCount }} </h5>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <h4 class="text-sm mb-4 text-uppercase font-weight-bold">Total Data Stock Code</h4>
                                    <h5 class="font-weight-bolder">
                                        {{ $stockCodeCount }} </h5>
                                </div>
                            </div>
            ...
            <div class="col-lg-12 mb-lg-0 mb-4">
                <div class="card z-index-2 h-100">
                    <div class="card-header pb-0 pt-3 bg-transparent">
                        <h6 class="text-capitalize">Grafik Total Data Keseluruhan</h6>
