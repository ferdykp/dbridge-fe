                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('dynamic.update', ['type' => $type, 'id' => $data->id]) }}" method="POST">
                            ...
                            <div id="wrFields">
                                @if (in_array(Auth::user()->role, ['sm']))
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control @error('componen_desc') is-invalid @enderror"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="plant_activity"
                                            value="{{ old('plant_activity', $data->plant_activity) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" style="text-transform:uppercase"
                                                    class="form-control @error('wr_no') is-invalid @enderror"
                                                    name="wr_no" value="{{ old('wr_no', $data->wr_no) }}"
                                                    placeholder="Insert WR_NO">
                                                <!-- error message untuk title -->
                                                @error('wr_no')
                                                    <div class="alert alert-danger mt-2">
                                                        {{ $message }}
                                    ...
                                    <div class="wr-group">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" style="text-transform:uppercase"
                                                class="form-control @error('home_wh') is-invalid @enderror"
                                                name="home_wh" value="{{ old('home_wh', $data->home_wh) }}"
                                                placeholder="Insert Home WH">
                                            <!-- error message untuk title -->
                                            @error('home_wh')
                                                <div class="alert alert-danger mt-2">
                                                    {{ $message }}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" style="text-transform:uppercase"
                                                        ...
                                                        name="price_code"
                                                        value="{{ old('price_code', $data->price_code) }}"
                                                        placeholder="Insert Price Code">
                                                    <!-- error message untuk title -->
                                                    @error('price_code')
                                                        <div class="alert alert-danger mt-2">
                            ...
                            <button type="submit" class="btn btn-md btn-primary me-3">Edit Data</button>
