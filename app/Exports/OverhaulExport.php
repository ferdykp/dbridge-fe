...
class OverhaulExport implements FromCollection, WithHeadings
{
    ...
    public function collection()
    {
        ...
        return Overhaul::select("dstrc_ori", "creation_date", "authsd_date", "wo_desc", "acuan_plan_service", "componen_desc", "egi", "egi_eng", "equip_no", "plant_process", "plant_activity", "wr_no", "wr_item", "qty_req")->get();
    }
